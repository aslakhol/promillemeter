...
export function calculateBAC(drinks: Drink[], weight: number, gender: Gender, drinkingDuration: number): number {
...
export function calculateResults(userData: UserData): CalculationResult {
  ...
  if (userData.bacInput !== null) {
    ...
    bac = calculateBAC(userData.drinks, userData.weight, userData.gender, userData.drinkingDuration)
  }
